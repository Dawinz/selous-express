    ...
    >
      <div className="bg-white rounded-xl shadow-2xl p-8 mx-4 max-w-md w-full text-center">
        ...
        <div className="flex items-center justify-center mb-6">
          <svg 
            className="animate-spin h-16 w-16 text-selous-orange" 
        ...
        {/* Title */}
        <h2 className="text-2xl md:text-3xl font-bebas font-bold text-selous-navy mb-4 tracking-wide">
          OPENING SAFARIYETU
        </h2>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <p className="text-xs font-poppins text-yellow-800">
