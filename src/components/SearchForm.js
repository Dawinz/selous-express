...
const SearchForm = ({ setIsBookingDialogOpen }) => {
  ...
  return (
    <div>
      <div>
          <div id="search-form" className="bg-gradient-to-br from-zuberi-navy via-zuberi-red to-zuberi-lime rounded-xl shadow-2xl shadow-zuberi-red/40 p-2 sm:p-6 md:p-10 mx-4 md:-mt-12 relative z-20 md:mx-4 sm:mx-8">
