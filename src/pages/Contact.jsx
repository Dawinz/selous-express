          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-bebas font-bold text-gray-800 text-lg">SIMU</h3>
                    <p className="text-gray-600 font-poppins">+255 712 345 678</p>
                    <p className="text-gray-600 font-poppins">+255 789 456 321</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-bebas font-bold text-gray-800 text-lg">OFISI</h3>
                    <p className="text-gray-600 font-poppins">Ubungo Terminal</p>
                    <p className="text-gray-600 font-poppins">Dar es Salaam, Tanzania</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-bebas font-bold text-gray-800">TUNAPATIKANA KILA SIKU</h3>
                    <p className="text-gray-600 font-poppins">6:00am – 10:00pm</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  <svg className="w-6 h-6 text-kisesa-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <h3 className="font-bebas font-bold text-gray-800">CUSTOMER SUPPORT</h3>
                    <p className="text-gray-600 font-poppins">Available 24/7 via WhatsApp</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-500 rounded-xl shadow-lg p-8 text-white text-center">
              ...
              <a
                ...
                className="inline-flex items-center bg-white text-green-500 font-poppins font-bold py-3 px-6 rounded-lg hover:bg-gray-100 transition-colors duration-200"
              >
