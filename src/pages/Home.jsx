  ...
  return (
    <div className="min-h-screen bg-zuberi-navy">
      ...
      <section className="relative">
        <Hero />
        {/* Mobile Form Overlay */}
        <div className="absolute inset-0 flex items-center justify-center md:hidden pl-8 pt-0 -mt-16">
      ...
      <section className="hidden md:block pt-0 pb-16 px-4 sm:px-6 lg:px-8 -mt-32 relative z-30">
